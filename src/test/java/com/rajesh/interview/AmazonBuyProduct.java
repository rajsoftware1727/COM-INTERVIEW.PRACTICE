...
public class AmazonBuyProduct {
	...
	public void buyIPHONE() throws Exception
	{
		...
		List<WebElement> listOfIPhonesDisplay=driver.findElements(By.xpath("//div[@class='left-pane-results-container']/div"));
		...
		/*for(WebElement t:listOfIPhonesDisplay)
		{
			String varietyOfIPhones=t.getAttribute("aria-label");
			if(varietyOfIPhones.equalsIgnoreCase("iphone 15 128gb"))
			{
				t.click();
			}
		}*/
